...
PrimaryHeader_custom = BitStruct('transfer_frame_version_number' / BitsInteger(2),
                          ...
                          'tranfer_frame_secondary_header_version' / BitsInteger(2),
                          'tranfer_frame_second_header_length' / BitsInteger(6), 
                          'transfer_frame_secondary_header_data' / BitsInteger(504),
                          'spacecraft_application_data' ,  
                          'operational_control_field_data' / BitsInteger(32),
                          'synch_flag' / Flag,
                          'packet_order_flag' / Flag,
                          'frame_error_control_field' / BitsInteger(16),

...
class tph(gr.basic_block):
    ...
    def __init__(self, transfer_frame_version_number, spacecraft_id, virtual_channel_id, ocf_flag, master_channel_frame_count,
                 ...
                 first_header_pointer, coding, reed_solomon_concat, e, q, I, turbo, ldpc_tf, ldpc_tf_size, num_of_octets, frame_error_control_field, transfer_frame_second_header_version,transfer_frame_second_header_length,transfer_frame_secondary_header_data, spacecraft_application_data,operational_control_field_data):
        ...
        self.transfer_frame_second_header_version = transfer_frame_second_header_version

        self.transfer_frame_second_header_length = transfer_frame_second_header_length

        self.transfer_frame_secondary_header_data = transfer_frame_secondary_header_data

        self.spacecraft_application_data = spacecraft_application_data

        self.operational_control_field_data = operational_control_field_data
    ...
    def calculateSize(self):
        ...
        def work(self):
            finalHeader = array.array('B', tele.PrimaryHeader_custom.build(
                dict(transfer_frame_version_number=self.transfer_frame_version_number,
                     ...
                     transfer_frame_second_header_version=self.transfer_frame_second_header_version,
                     transfer_frame_second_header_length=self.transfer_frame_second_header_length,
                     transfer_frame_secondary_header_data=self.transfer_frame_secondary_header_data,
                     spacecraft_application_data=self.spacecraft_application_data,
                     operational_control_field_data=self.operational_control_field_data
                     )))
            return finalHeader
